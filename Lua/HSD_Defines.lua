...
ARCHER =		GameInfo.Units.UNIT_SPEARMAN.ID
...
ALLOW_CITY_STATES_ALLY =			true -- Give allied influence on city-states in range = ALLY_CITY_STATES_RANGE
...
MINOR_RANGE_PERCENT =				50 -- percentage of normal range used for new minor civilization balance
